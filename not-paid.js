...
(function(){
	...
	const show_future_developer_notice = true;
	/* stop changing here */
	...
	const future_developer_notice =
	  "NON-PAYMENT WARNING: The client's failure to pay on time has caused " +
		"this website to fade into oblivion. Work for this client at your own risk."
	...
	if(days > 0) {
		...
		if(opacity >= 0 && opacity <= 1) {
			...
			if(show_future_developer_notice) {
				console.log(future_developer_notice);
			}
		}
	}
})()
